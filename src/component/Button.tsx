...
const BlackButton: React.FC<BlackButtonProps> = ({ onPress, style }) => {
    return (
        <TouchableOpacity onPress={onPress} style={[styles.BlackButton, style]}>
            <Text style={styles.BlackText}>Okey</Text>
        </TouchableOpacity>
    );
};
...
const PrimaryBorderButton: React.FC<PrimaryBorderButtonProps> = ({ onPress, style , title }) => {
    return(
...
export { Button, TouchableButton, SendAgainButton , BlackButton , PrimaryBorderButton};